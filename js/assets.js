...
(function (NoDog) {
  ...
  /* 6面「もじもじわんこ」の語彙。写真を使わず、この文字だけで出題する。
     ...
     語を足したら tools/build_font.py を回すこと（字が無いと豆腐になる）。 */
  var WORD_DOGS = ['シーズー', 'ボルゾイ', 'サルーキ', 'パピヨン',
                   'チャウチャウ', 'コモンドール', 'ウィペット', '狆',
                   'プーリー', 'ボロニーズ', 'ハバニーズ', 'バセンジー',
                   'ケルピー', 'ぬれたいぬ', 'あきたいぬ', 'うちのいぬ'];
  var WORD_NOTS = ['わんこそば', '犬張子', '犬走り', '狛犬', 'ホットドッグ',
                   '犬釘', 'いぬのおまわりさん', '負け犬', '犬かき', '犬矢来',
                   '犬小屋', '犬歯', 'ドッグイヤー', '犬猿の仲', '柴漬け',
                   'わんこのそばにいる俺', '犬も歩けば'];
